...
if 'qq' in dataname:
	filename='Full_gYqq'+g_coupling+'MY'+MY_input+'MF'+MF_input
if 'gg' in dataname:
	filename='Full_gYgg'+g_coupling+'MY'+MY_input+'MF'+MF_input

print filename
fout1= open(dir+'delphes_cards/'+filename+'-lhe-pythia8-delphes-default.dat',"w")
fout2= open(dir+'delphes_cards/'+filename+'-pythia8card.dat',"w")
