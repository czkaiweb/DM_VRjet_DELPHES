...
int delphes_analysis(char* string){
  ...
  finname = "../..//delphes_results/"+finname+"/delphes/myprocess_atlas13tev.root"; // By default atlas13tev is called, following the delphes cards, finname generally is the mode+scanning parameter)
